...
public class PlayerWeaponsManager : MonoBehaviour
{
    ...
    public bool isPointingAtHookable { get; private set; }
    ...
    private void Update()
    {
        ...
        //Pointing at hookable handling
        isPointingAtHookable = false;
        if(Physics.Raycast(weaponCamera.transform.position, weaponCamera.transform.forward, out RaycastHit raycastHit))
        {
            if (raycastHit.transform.gameObject.CompareTag("Hookable"))
            {
                isPointingAtHookable = true;
            }
        }
    }
